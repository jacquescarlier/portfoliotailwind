...
const defaultClasses = {
    cardStyle1: ' w-full mx-auto mt-8 bg-gray-200 border-l-[1px] border-b-[1px] border-[#FFD700] rounded-b-md rounded-t-[10px] rounded-t-md shadow-lg shadow-sky-800/60  transition-all hover:opacity-80',
